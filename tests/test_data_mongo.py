...
class TestData(unittest.TestCase):
    ...
    def test_generic_create(self):
        ...
        data.generic_create(collections.DRIVER_ITERATIONS, {
                            'test': True}, new_case, token, False)
        driv_iter = json.loads(data.generic_get(
            collections.DRIVER_ITERATIONS, new_case, token))[0]
        self.assertTrue(driv_iter['test'])

    def test_generic_create_fail(self):
        new_case = data.create_case({}, token)
        result = data.generic_create(collections.DRIVER_ITERATIONS, {
                                     'test': True}, new_case, 'badtoken',
                                     False)
    ...
    def test_generic_delete(self):
        ...
        self.assertEqual(data.generic_get(
            collections.DRIVER_ITERATIONS, new_case, token), '[]')

    def test_create_replace_iter_coord(self):
        new_case = data.create_case({}, token)
        data.generic_create(collections.DRIVER_ITERATIONS, {
                            'iteration_coordinate': '123', 'test': True},
                            new_case, token, False)
        data.generic_create(collections.DRIVER_ITERATIONS, {
                            'iteration_coordinate': '123', 'test': False},
                            new_case, token, True)
        driv_iter = json.loads(data.generic_get(
            collections.DRIVER_ITERATIONS, new_case, token))[0]
    ...
    def test_create_replace_counter(self):
        new_case = data.create_case({}, token)
        data.generic_create(collections.DRIVER_ITERATIONS, {
                            'counter': '123', 'test': True}, new_case, token,
                            False)
        data.generic_create(collections.DRIVER_ITERATIONS, {
                            'counter': '123', 'test': False}, new_case, token,
                            True)
        driv_iter = json.loads(data.generic_get(
            collections.DRIVER_ITERATIONS, new_case, token))[0]
        self.assertFalse(driv_iter['test'])
    ...
    def test_create_replace_solver_class(self):
        new_case = data.create_case({}, token)
        data.generic_create(collections.DRIVER_ITERATIONS, {
                            'solver_class': '123', 'test': True}, new_case,
                            token, False)
        data.generic_create(collections.DRIVER_ITERATIONS, {
                            'solver_class': '123', 'test': False}, new_case,
                            token, True)
        driv_iter = json.loads(data.generic_get(
            collections.DRIVER_ITERATIONS, new_case, token))[0]
        self.assertFalse(driv_iter['test'])
    ...
    def test_create_replace_none(self):
        ...
        data.generic_create(collections.DRIVER_ITERATIONS, {
                            'test': True}, new_case, token, False)
        data.generic_create(collections.DRIVER_ITERATIONS, {
                            'test': False}, new_case, token, True)
        driv_iter = json.loads(data.generic_get(
            collections.DRIVER_ITERATIONS, new_case, token))[0]
        self.assertFalse(driv_iter['test'])
    ...
    def test_get_system_iteration_data(self):
        new_case = data.create_case({}, token)
        data.generic_create(collections.SYSTEM_ITERATIONS, {
    ...
    def test_get_many(self):
        new_case = data.create_case({}, token)
        data.generic_create(collections.SOLVER_ITERATIONS, {
                            'test': 1}, new_case, token, False)
        data.generic_create(collections.SOLVER_ITERATIONS, {
                            'test': 2}, new_case, token, False)
        data.generic_create(collections.SOLVER_ITERATIONS, {
                            'test': 3}, new_case, token, False)
        sol_iters = json.loads(data.generic_get(
            collections.SOLVER_ITERATIONS, new_case, token, get_many=True))
    ...
    def test_get_one(self):
        ...
        data.generic_create(collections.SOLVER_ITERATIONS, {
                            'test': 3}, new_case, token, False)
        sol_iters = json.loads(data.generic_get(
            collections.SOLVER_ITERATIONS, new_case, token, get_many=False))
    ...
    def test_delete_token(self):
        ...
        new_case = data.create_case({}, new_token)
        data.generic_create(collections.DRIVER_ITERATIONS, {
                            'test': True}, new_case, new_token, False)
        ...
        driv_iter = json.loads(data.generic_get(
            collections.DRIVER_ITERATIONS, new_case, new_token))[0]
        self.assertTrue(driv_iter['test'])
        data.delete_token(new_token)
        self.assertFalse(data.token_exists(new_token))
        self.assertEqual(data.get_case_with_id(new_case, new_token), {})
        self.assertEqual(data.generic_get(
            collections.DRIVER_ITERATIONS, new_case, new_token), '[]')
    ...
    def test_get_many_globally_accepted_token(self):
        ...
        data.generic_create(collections.SYSTEM_ITERATIONS, {
                            'test': True}, new_case, token, False)
        sys_iters = json.loads(data.generic_get(
            collections.SYSTEM_ITERATIONS, new_case,
            data._GLOBALLY_ACCEPTED_TOKEN))
    ...
    def test_get_one_globally_accepted_token(self):
        ...
        sys_iters = json.loads(data.generic_get(
            collections.SYSTEM_ITERATIONS, new_case,
            data._GLOBALLY_ACCEPTED_TOKEN, False))
    ...
    def test_update_without_access(self):
        ...
        data.generic_create(collections.SYSTEM_ITERATIONS, {
                            'iteration_coordinate': 123, 'test': True},
                            new_case, token, False)
        self.assertFalse(data.generic_create(collections.SYSTEM_ITERATIONS, {
                         'iteration_coordinate': 123, 'test': False}, new_case,
                         'bad token', True))
    ...
    def test_update_layout(self):
        ...
        new_case_layout = json.loads(data.generic_get(
            collections.LAYOUTS, new_case, data._GLOBALLY_ACCEPTED_TOKEN,
            False))
