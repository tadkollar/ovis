...
class TestSqliteData(unittest.TestCase):
    ...
    def test_connect_sellar(self):
        ...
        self.assertEqual(_data.filename, self._sellar_grouped_location_py2)

    @unittest.skipIf(PY2, 'Test requires PY3')
    def test_connect_sellar_py3(self):
        self._use_sellar_grouped_py3()
        self.assertEqual(_data.filename, self._sellar_grouped_location_py3)
    ...
    @unittest.skipIf(PY2, 'Test requires PY3')
    def test_get_driver_iteration_py3(self):
        self._use_sellar_grouped_py3()
        iterations = _data.generic_get(collections.DRIVER_ITERATIONS)
    ...
    @unittest.skipIf(PY2, 'Test requires PY3')
    def test_get_driver_metadata_py3(self):
        self._use_sellar_grouped_py3()
        metadata_s = _data.generic_get(collections.DRIVER_METADATA)
        metadata = metadata_s[0]
        self.assertIsNotNone(metadata['model_viewer_data'])
    ...
    def test_get_layout(self):
        ...
        layout = json.loads(layout_s[0]['layout'])
    ...
    def test_metadata(self):
        self._use_sellar_grouped()
        metadata = _data.generic_get(collections.METADATA)
    ...
    def test_update_layout(self):
        ...
        _data.update_layout(json.dumps(new_layout))
        layout_s = _data.generic_get(collections.LAYOUTS)
        layout = layout_s[0]
    ...
    def test_get_one_driver_iteration(self):
        self._use_sellar_grouped()
        ret = _data.generic_get(collections.DRIVER_ITERATIONS, False)
        self.assertEqual(len(ret), 1)

    def test_get_many_driver_iterations(self):
        self._use_sellar_grouped()
        ret = _data.generic_get(collections.DRIVER_ITERATIONS, True)
    ...
    def _use_sellar_grouped_py3(self):
        """ use_sellar_grouped_py2 private method

        Connects _data to the py2 version of the sellar grouped DB
        """
        _data.connect(self._sellar_grouped_location_py3)
