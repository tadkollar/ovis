...
function addVariableIndicesGroup(name, curIndices) {
    var content = "<div id='div_" + name + "'><br/>\r\n<div class='form-group' style='padding-right: 25px'>\r\n" +
        "<label class='control-label'> " + name + " Indices</label> <button type='button' class='btn btn-sm' data-toggle='modal' data-target='#selectIndicesModal'><span class='glyphicon glyphicon-info-sign'></span></button>\r\n" +
